%% FORECASTING_3_vsUNIVARIATE.m:
% Third forecasting exercise in Korobilis and Schroeder (2023) Monitoring 
% Multicountry Macroeconomic Risk.
%
% Compare the benchmark QFAVAR with a QDFM (i.e. QFAVAR without global predictors)
% as well as univariate QAR(1) models (with and without global predictors).
% =========================================================================
% Written by: 
%
...
for sample = T_thres:T_full
    ...
    %% QDFM forecasts
    [xforeQR] = QFAVAR_FORE2(x(1:sample,:),xlag(1:sample,:),sample,n,r*nq*p + interF,[],0,r,p,quant,h,interX,interF,AR1x,incldg,var_sv,ALsampler,nsave,nburn,nthin);
    % Create forecast statistics
    for ivar = 1:varnum
        for nfore = 1:h
            post_mean_quants = xforeQR(ivar,:,nfore);   
    ...
    %% Univariate AR(1) models
    for ivar = 1:18
        for nfore = 1:h
            [xforeQR] = TVPSVQR(x(2+nfore:sample,ivar),[ones(sample-nfore-1,1) x(2:sample-nfore,ivar) x(1:sample-nfore-1,ivar)],[1 x(sample,ivar) x(sample-1,ivar)],nsave,nburn,nthin,quant,0,0,3);
            post_mean_quants = mean(xforeQR,2);   
    ...
    %% Univariate AR(1)+global factors models
    for ivar = 1:18
        for nfore = 1:h
            [xforeQR] = TVPSVQR(x(2+nfore:sample,ivar),[ones(sample-nfore-1,1) x(2:sample-nfore,ivar) x(1:sample-nfore-1,ivar) g(2:sample-nfore,:)],[1 x(sample,ivar) x(sample-1,ivar) g(sample,:)],nsave,nburn,nthin,quant,0,0,3);
            post_mean_quants = mean(xforeQR,2);   
...
for j = 1:4
    for i=1:9
        subplot(4,9,(j-1)*9+i)
        if j == 1
        plot(1:144,squeeze(cumsum(QScore10(:,i,1,1))),'-',1:144,squeeze(cumsum(QScore10(:,i,1,2))),':','LineWidth',2);
                if i == 1
                    ylabel('10\%, HICP');
                end
            grid on;   
            ...
            title(names(i))                 
        elseif j == 2        
            plot(1:144,squeeze(cumsum(QScore90(:,i,1,1))),'-',1:144,squeeze(cumsum(QScore90(:,i,1,2))),':','LineWidth',2);
               if i == 1
                    ylabel('90\%, HICP');
               end
            grid on;   
            ...
            title(names(i))                
        elseif j == 3
            plot(1:144,squeeze(cumsum(QScore10(:,i+9,1,1))),'-',1:144,squeeze(cumsum(QScore10(:,i+9,1,2))),':','LineWidth',2);
               if i == 1
                    ylabel('10\%, IP');
               end
            grid on;   
            ...
            title(names(i+9))                
        elseif j == 4        
            plot(1:144,squeeze(cumsum(QScore90(:,i+9,1,1))),'-',1:144,squeeze(cumsum(QScore90(:,i+9,1,2))),':','LineWidth',2);
               if i == 1
                    ylabel('90\%, IP');
               end
            grid on;   
...
%sgtitle([num2str(h) '-step ahead QScores of 10th percentile'])
saveas(gcf,"forecasting_3_h=1.jpg")
...
for j = 1:4
    for i=1:9
        subplot(4,9,(j-1)*9+i)
        if j == 1
        plot(1:144,squeeze(cumsum(QScore10(:,i,6,1))),'-',1:144,squeeze(cumsum(QScore10(:,i,6,2))),':','LineWidth',2);
                if i == 1
                    ylabel('10\%, HICP');
                end
            grid on;   
            ...
            title(names(i))                 
        elseif j == 2        
            plot(1:144,squeeze(cumsum(QScore90(:,i,6,1))),'-',1:144,squeeze(cumsum(QScore90(:,i,6,2))),':','LineWidth',2);
               if i == 1
                    ylabel('90\%, HICP');
               end
            grid on;   
            ...
            title(names(i))                
        elseif j == 3
            plot(1:144,squeeze(cumsum(QScore10(:,i+9,6,1))),'-',1:144,squeeze(cumsum(QScore10(:,i+9,6,2))),':','LineWidth',2);
               if i == 1
                    ylabel('10\%, IP');
               end
            grid on;   
            ...
            title(names(i+9))                
        elseif j == 4        
            plot(1:144,squeeze(cumsum(QScore90(:,i+9,6,1))),'-',1:144,squeeze(cumsum(QScore90(:,i+9,6,2))),':','LineWidth',2);
               if i == 1
                    ylabel('90\%, IP');
               end
            grid on;   
...
%sgtitle([num2str(h) '-step ahead QScores of 10th percentile'])
saveas(gcf,"forecasting_3_h=6.jpg")
...
for j = 1:4
    for i=1:9
        subplot(4,9,(j-1)*9+i)
        if j == 1
        plot(1:144,squeeze(cumsum(QScore10(:,i,12,1))),'-',1:144,squeeze(cumsum(QScore10(:,i,12,2))),':','LineWidth',2);
                if i == 1
                    ylabel('10\%, HICP');
                end
            grid on;   
            ...
            title(names(i))                 
        elseif j == 2        
            plot(1:144,squeeze(cumsum(QScore90(:,i,12,1))),'-',1:144,squeeze(cumsum(QScore90(:,i,12,2))),':','LineWidth',2);
               if i == 1
                    ylabel('90\%, HICP');
               end
            grid on;   
            ...
            title(names(i))                
        elseif j == 3
            plot(1:144,squeeze(cumsum(QScore10(:,i+9,12,1))),'-',1:144,squeeze(cumsum(QScore10(:,i+9,12,2))),':','LineWidth',2);
               if i == 1
                    ylabel('10\%, IP');
               end
            grid on;   
            ...
            title(names(i+9))                
        elseif j == 4        
            plot(1:144,squeeze(cumsum(QScore90(:,i+9,12,1))),'-',1:144,squeeze(cumsum(QScore90(:,i+9,12,2))),':','LineWidth',2);
               if i == 1
                    ylabel('90\%, IP');
               end
            grid on;   
...
%sgtitle([num2str(h) '-step ahead QScores of 10th percentile'])
saveas(gcf,"forecasting_3_h=12.jpg")
...
for j = 1:4
    for i=1:9
        subplot(4,9,(j-1)*9+i)
        if j == 1
        plot(1:144,squeeze(cumsum(QScore10(:,i,24,1))),'-',1:144,squeeze(cumsum(QScore10(:,i,24,2))),':','LineWidth',2);
                if i == 1
                    ylabel('10\%, HICP');
                end
            grid on;   
            ...
            title(names(i))                 
        elseif j == 2        
            plot(1:144,squeeze(cumsum(QScore90(:,i,24,1))),'-',1:144,squeeze(cumsum(QScore90(:,i,24,2))),':','LineWidth',2);
               if i == 1
                    ylabel('90\%, HICP');
               end
            grid on;   
            ...
            title(names(i))                
        elseif j == 3
            plot(1:144,squeeze(cumsum(QScore10(:,i+9,24,1))),'-',1:144,squeeze(cumsum(QScore10(:,i+9,24,2))),':','LineWidth',2);
               if i == 1
                    ylabel('10\%, IP');
               end
            grid on;   
            ...
            title(names(i+9))                
        elseif j == 4        
            plot(1:144,squeeze(cumsum(QScore90(:,i+9,24,1))),'-',1:144,squeeze(cumsum(QScore90(:,i+9,24,2))),':','LineWidth',2);
               if i == 1
                    ylabel('90\%, IP');
               end
            grid on;   
...
%sgtitle([num2str(h) '-step ahead QScores of 10th percentile'])
saveas(gcf,"forecasting_3_h=24.jpg")




%% Save results to mat file
save(sprintf('%s.mat','FORECASTING_3'),'-mat');
